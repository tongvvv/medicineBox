...
public:
    ...
    void setupUi(QWidget *store_page1)
    {
        ...
        horizontalLayout->setContentsMargins(100, 0, 100, 20);
...
"}"));
        ...
        sizePolicy1.setHeightForWidth(skip->sizePolicy().hasHeightForWidth());
        skip->setSizePolicy(sizePolicy1);
        skip->setFont(font4);
...
"}"));
    ...
    void retranslateUi(QWidget *store_page1)
    {
        ...
        label_2->setText(QCoreApplication::translate("store_page1", "TextLabel", nullptr));
